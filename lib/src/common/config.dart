...
class Config {
  ...
  /// ip
  static const defaultIp = "im.kchat.live"; //43.128.5.63"; //121.37.25.71
  ...
  static String appAuthUrl() {
    ...
    return url ?? "https://$defaultIp:42234";
  }
  ...
  static String imApiUrl() {
    ...
    return url ?? 'https://$defaultIp:10001';
  }
